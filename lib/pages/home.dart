import 'package:doctor_booking_app/models/doctor.dart';
import 'package:doctor_booking_app/pages/detail.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final List<DoctorModel> doctorData = DoctorModel.getDoctors();
