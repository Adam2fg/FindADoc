  ...
  static List<DoctorModel> getDoctors() {
    ...
    doctors.add(
      DoctorModel(
          ...
          image: 'assets/images/drjenny.png',
          ...
          score: 4.8,
          bio:
              'Dr. Jenny Wilson (Implantologist), is a highly skilled dental surgeon with over 10 years of experience in providing exceptional dental care. She specializes in aesthetic dentistry and is dedicated to helping patients achieve their best smiles. ',
          calendar: [
    ...
    doctors.add(DoctorModel(
        ...
        image: 'assets/images/drkristin.png',
        imageBox: const Color(0xff3CFFC4).withOpacity(0.3),
        specialties: ['Dental Surgeon', 'Aesthetic Surgeon', 'General Dentist'],
        score: 4.8,
        bio:
            ' Dr. Kristin Watson is a compassionate and experienced dental surgeon with a focus on patient-centered care. With over 8 years of experience, she is committed to providing high-quality dental treatments and ensuring patient comfort.',
        calendar: [
          CalendarModel(dayNumber: 14, dayName: 'Sun', isSelected: false),
          CalendarModel(dayNumber: 15, dayName: 'Mon', isSelected: false),
          CalendarModel(dayNumber: 16, dayName: 'Tue', isSelected: true),
